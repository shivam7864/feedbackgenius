...
const Dashboard = () => {
  ...
  if (typeof window !== 'undefined') {
    ...
    profileUrl = `${baseUrl}/yourprofile/${username}`
  }
  ...
  return (
    <div className='my-8 mx-4 md:mx-8  lg:mx-auto p-6 bg-white rounded w-full max-w-6xl'>
      ...
      <div className='mt-4 grid grid-cols-1 md:grids-cols-2 gap-6'>
        {
          messages.length>0 ? (
            messages.map((message,index)=>(
              <MessageCard key={message._id as KeyType} message={message} onMessageDelete={handleDeleteMessage}/>
            ))
          ) : (
